...
var TWITCH_API_URL = 'https://api.twitch.tv/api';
...
var TwitchClient = function () {
  ...
  (0, _createClass3.default)(TwitchClient, [{
    ...
    value: function getParams(config) {
      ...
      return (0, _ramda.uniq)(REQUIRED_FIELDS.concat((0, _keys2.default)(config))).reduce(function (acc, field) {
        if (config[field] || _this[field]) acc[(0, _snakeCase2.default)(field)] = config[field] || _this[field];
        return acc;
      }, {});
    }
  }, {
